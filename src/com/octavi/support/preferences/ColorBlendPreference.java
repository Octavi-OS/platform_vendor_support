...
package com.octavi.support.preferences;
...
import com.octavi.support.R;
import com.octavi.support.colorpicker.ColorPickerDialog;
...
public class ColorBlendPreference extends Preference
    ...
    private void updateDialogSliderPreview() {
        ...
        mDialogPreviewColorBetween.setBackgroundColor(
                OctaviUtils.getBlendColorForPercent(mPreviewColorEnd, mPreviewColorStart,
    ...
    private void updatePreview() {
        ...
        if (mViewColorBetween != null) {
            mViewColorBetween.setBackgroundColor(
                    OctaviUtils.getBlendColorForPercent(mColorEnd, mColorStart, mBlendReverse, 50));
        }
    }
